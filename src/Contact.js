...
const contact = (e) => {
    ...
    document.form.action="https://getsimpleform.com/messages?form_api_token=f24d273e98e8b6c9e5f6874fd1d04c5c"
...
const Contact = () => {
    ...
    return(
        <div>
            <Helmet>
                <title>Contact | Hanish Rao</title>
                ...
                <script>
                    {'var LandbotLiveConfig = { index: \'https://landbot.io/u/H-202846-JWIHZL4PFQ3TQ03D/index.html\', accent: \'#444444\' }'}
                </script>
