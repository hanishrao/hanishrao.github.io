...
const Legal = () => {
    ...
    return(
      <div>
          <Helmet>
            <title>Legal | Hanish Rao</title>
          </Helmet>
          <Navbar />
          <br/>
          <div className="container">
              <p className="about-me">
                <strong>Contents of this site are &copy; Copyright 2019, Hanishraj B Rao. All rights reserved.</strong> <br/>
                The&nbsp;
                 <a
                 href="_blank"
                 alt="source code"
              ...
              <p className="about-me">
                This privacy policy governs your access to and use of hyraze.github.io, including any content, functionality
                and services offered on or through hanishrao.github.io (the “Website”).
              </p>
